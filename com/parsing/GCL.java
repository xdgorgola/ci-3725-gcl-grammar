...
public class GCL extends Lexer {
	...
	public static final int
		...
		TkConcat=22, TkOBracket=23, TkCBracket=24, TkPlus=25, TkMinus=26, TkMult=27, 
		TkNot=28, TkTwoPoints=29, TkLess=30, TkGreater=31, TkNEqual=32, TkLeq=33, 
		TkGeq=34, TkEqual=35, TkOr=36, TkAnd=37, TkTrue=38, TkFalse=39, TkNum=40, 
		TkString=41, TkId=42, SLCMT=43, WS=44;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TkConcat", "TkOBracket", "TkCBracket", "TkPlus", "TkMinus", "TkMult", 
			"TkNot", "TkTwoPoints", "TkLess", "TkGreater", "TkNEqual", "TkLeq", "TkGeq", 
			"TkEqual", "TkOr", "TkAnd", "TkTrue", "TkFalse", "TkNum", "TkString", 
			"TkId", "SLCMT", "WS"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TkArrow", "TkConcat", "TkOBracket", "TkCBracket", "TkPlus", "TkMinus", 
